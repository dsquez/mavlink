...
enum class MAV_FRAME : uint8_t
{
    ...
    RESERVED_12=12, /* MAV_FRAME_BODY_FRD - Body fixed frame of reference, Z-down (x: Forward, y: Right, z: Down). | */
...
constexpr auto WIFI_CONFIG_AP_MODE_ENUM_END = 3;
