...
static void mavlink_test_taa_ack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_ACK >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_ack_t packet_in = {
        17235,17339
    };
    mavlink_taa_ack_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.message_type = packet_in.message_type;
        packet1.sequence_response = packet_in.sequence_response;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_ACK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_ACK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_ack_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_ack_pack(system_id, component_id, &msg , packet1.message_type , packet1.sequence_response );
    mavlink_msg_taa_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_ack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.message_type , packet1.sequence_response );
    mavlink_msg_taa_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_ack_send(MAVLINK_COMM_1 , packet1.message_type , packet1.sequence_response );
    mavlink_msg_taa_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_nack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_NACK >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_nack_t packet_in = {
        963497464,17443,17547
    };
    mavlink_taa_nack_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.error_type = packet_in.error_type;
        packet1.message_type = packet_in.message_type;
        packet1.sequence_response = packet_in.sequence_response;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_NACK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_NACK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_nack_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_nack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_nack_pack(system_id, component_id, &msg , packet1.message_type , packet1.sequence_response , packet1.error_type );
    mavlink_msg_taa_nack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_nack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.message_type , packet1.sequence_response , packet1.error_type );
    mavlink_msg_taa_nack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_nack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_nack_send(MAVLINK_COMM_1 , packet1.message_type , packet1.sequence_response , packet1.error_type );
    mavlink_msg_taa_nack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_drone_telemetry(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_DRONE_TELEMETRY >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_drone_telemetry_t packet_in = {
        93372036854775807ULL,963497880,17859,175
    };
    mavlink_taa_drone_telemetry_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.seconds = packet_in.seconds;
        packet1.nanoseconds = packet_in.nanoseconds;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_DRONE_TELEMETRY_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_DRONE_TELEMETRY_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_drone_telemetry_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_drone_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_drone_telemetry_pack(system_id, component_id, &msg , packet1.sequence , packet1.version , packet1.seconds , packet1.nanoseconds );
    mavlink_msg_taa_drone_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_drone_telemetry_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sequence , packet1.version , packet1.seconds , packet1.nanoseconds );
    mavlink_msg_taa_drone_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_drone_telemetry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_drone_telemetry_send(MAVLINK_COMM_1 , packet1.sequence , packet1.version , packet1.seconds , packet1.nanoseconds );
    mavlink_msg_taa_drone_telemetry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_get_parameters_from_vest(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_GET_PARAMETERS_FROM_VEST >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_get_parameters_from_vest_t packet_in = {
        17235,17339
    };
    mavlink_taa_get_parameters_from_vest_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.parameter_list_version = packet_in.parameter_list_version;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_GET_PARAMETERS_FROM_VEST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_GET_PARAMETERS_FROM_VEST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameters_from_vest_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_get_parameters_from_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameters_from_vest_pack(system_id, component_id, &msg , packet1.parameter_list_version , packet1.parameter_index );
    mavlink_msg_taa_get_parameters_from_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameters_from_vest_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.parameter_list_version , packet1.parameter_index );
    mavlink_msg_taa_get_parameters_from_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_get_parameters_from_vest_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameters_from_vest_send(MAVLINK_COMM_1 , packet1.parameter_list_version , packet1.parameter_index );
    mavlink_msg_taa_get_parameters_from_vest_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_set_parameters_on_vest(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_SET_PARAMETERS_ON_VEST >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_set_parameters_on_vest_t packet_in = {
        963497464,17443,17547,29
    };
    mavlink_taa_set_parameters_on_vest_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.parameter_value = packet_in.parameter_value;
        packet1.parameter_list_version = packet_in.parameter_list_version;
        packet1.parameter_index = packet_in.parameter_index;
        packet1.interpretation_type = packet_in.interpretation_type;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_SET_PARAMETERS_ON_VEST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_SET_PARAMETERS_ON_VEST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_set_parameters_on_vest_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_set_parameters_on_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_set_parameters_on_vest_pack(system_id, component_id, &msg , packet1.parameter_list_version , packet1.parameter_index , packet1.parameter_value , packet1.interpretation_type );
    mavlink_msg_taa_set_parameters_on_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_set_parameters_on_vest_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.parameter_list_version , packet1.parameter_index , packet1.parameter_value , packet1.interpretation_type );
    mavlink_msg_taa_set_parameters_on_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_set_parameters_on_vest_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_set_parameters_on_vest_send(MAVLINK_COMM_1 , packet1.parameter_list_version , packet1.parameter_index , packet1.parameter_value , packet1.interpretation_type );
    mavlink_msg_taa_set_parameters_on_vest_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_play_sound_on_vest(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_PLAY_SOUND_ON_VEST >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_play_sound_on_vest_t packet_in = {
        963497464,17443,151
    };
    mavlink_taa_play_sound_on_vest_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.sequence = packet_in.sequence;
        packet1.sound_index = packet_in.sound_index;
        packet1.volume_level = packet_in.volume_level;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_PLAY_SOUND_ON_VEST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_PLAY_SOUND_ON_VEST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_play_sound_on_vest_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_play_sound_on_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_play_sound_on_vest_pack(system_id, component_id, &msg , packet1.sound_index , packet1.sequence , packet1.volume_level );
    mavlink_msg_taa_play_sound_on_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_play_sound_on_vest_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sound_index , packet1.sequence , packet1.volume_level );
    mavlink_msg_taa_play_sound_on_vest_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_play_sound_on_vest_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_play_sound_on_vest_send(MAVLINK_COMM_1 , packet1.sound_index , packet1.sequence , packet1.volume_level );
    mavlink_msg_taa_play_sound_on_vest_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_canine_telemetry(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_CANINE_TELEMETRY >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_canine_telemetry_t packet_in = {
        93372036854775807ULL,179.0,235.0,963498712,213.0,241.0,269.0,963499544,19523,15
    };
    mavlink_taa_canine_telemetry_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.seconds = packet_in.seconds;
        ...
        packet1.altitude_hae = packet_in.altitude_hae;
        packet1.heading_angle = packet_in.heading_angle;
        packet1.seconds_since_last_alert = packet_in.seconds_since_last_alert;
        packet1.sequence = packet_in.sequence;
        packet1.version = packet_in.version;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_CANINE_TELEMETRY_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_CANINE_TELEMETRY_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_canine_telemetry_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_canine_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_canine_telemetry_pack(system_id, component_id, &msg , packet1.sequence , packet1.version , packet1.seconds , packet1.nanoseconds , packet1.gps_lat , packet1.gps_lon , packet1.altitude_msl , packet1.altitude_hae , packet1.heading_angle , packet1.seconds_since_last_alert );
    mavlink_msg_taa_canine_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_canine_telemetry_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sequence , packet1.version , packet1.seconds , packet1.nanoseconds , packet1.gps_lat , packet1.gps_lon , packet1.altitude_msl , packet1.altitude_hae , packet1.heading_angle , packet1.seconds_since_last_alert );
    mavlink_msg_taa_canine_telemetry_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_canine_telemetry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_canine_telemetry_send(MAVLINK_COMM_1 , packet1.sequence , packet1.version , packet1.seconds , packet1.nanoseconds , packet1.gps_lat , packet1.gps_lon , packet1.altitude_msl , packet1.altitude_hae , packet1.heading_angle , packet1.seconds_since_last_alert );
    mavlink_msg_taa_canine_telemetry_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_get_parameter_reply(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_GET_PARAMETER_REPLY >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_get_parameter_reply_t packet_in = {
        963497464,17443,17547
    };
    mavlink_taa_get_parameter_reply_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.parameter_value = packet_in.parameter_value;
        packet1.parameter_list_version = packet_in.parameter_list_version;
        packet1.parameter_index = packet_in.parameter_index;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_GET_PARAMETER_REPLY_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_GET_PARAMETER_REPLY_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameter_reply_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_get_parameter_reply_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameter_reply_pack(system_id, component_id, &msg , packet1.parameter_list_version , packet1.parameter_index , packet1.parameter_value );
    mavlink_msg_taa_get_parameter_reply_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameter_reply_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.parameter_list_version , packet1.parameter_index , packet1.parameter_value );
    mavlink_msg_taa_get_parameter_reply_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_get_parameter_reply_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_get_parameter_reply_send(MAVLINK_COMM_1 , packet1.parameter_list_version , packet1.parameter_index , packet1.parameter_value );
    mavlink_msg_taa_get_parameter_reply_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_taa_alert_detected(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TAA_ALERT_DETECTED >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_taa_alert_detected_t packet_in = {
        93372036854775807ULL,963497880,17859,17963,53,120
    };
    mavlink_taa_alert_detected_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.seconds = packet_in.seconds;
        packet1.nanoseconds = packet_in.nanoseconds;
        packet1.sequence = packet_in.sequence;
        packet1.alert_count = packet_in.alert_count;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TAA_ALERT_DETECTED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TAA_ALERT_DETECTED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_alert_detected_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_taa_alert_detected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_alert_detected_pack(system_id, component_id, &msg , packet1.sequence , packet1.alert_count , packet1.seconds , packet1.nanoseconds , packet1.volume , packet1.confidence );
    mavlink_msg_taa_alert_detected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_alert_detected_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sequence , packet1.alert_count , packet1.seconds , packet1.nanoseconds , packet1.volume , packet1.confidence );
    mavlink_msg_taa_alert_detected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_taa_alert_detected_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_taa_alert_detected_send(MAVLINK_COMM_1 , packet1.sequence , packet1.alert_count , packet1.seconds , packet1.nanoseconds , packet1.volume , packet1.confidence );
    mavlink_msg_taa_alert_detected_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_taa_ack(system_id, component_id, last_msg);
    mavlink_test_taa_nack(system_id, component_id, last_msg);
    mavlink_test_taa_drone_telemetry(system_id, component_id, last_msg);
    mavlink_test_taa_get_parameters_from_vest(system_id, component_id, last_msg);
    mavlink_test_taa_set_parameters_on_vest(system_id, component_id, last_msg);
    mavlink_test_taa_play_sound_on_vest(system_id, component_id, last_msg);
    mavlink_test_taa_canine_telemetry(system_id, component_id, last_msg);
    mavlink_test_taa_get_parameter_reply(system_id, component_id, last_msg);
    mavlink_test_taa_alert_detected(system_id, component_id, last_msg);
}
