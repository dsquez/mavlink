...
TEST(ardupilotmega, TAA_ACK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_ACK packet_in{};
    packet_in.message_type = 17235;
    packet_in.sequence_response = 17339;

    mavlink::ardupilotmega::msg::TAA_ACK packet1{};
    mavlink::ardupilotmega::msg::TAA_ACK packet2{};
    ...
    EXPECT_EQ(packet1.sequence_response, packet2.sequence_response);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_ACK)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_taa_ack_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.sequence_response, packet2.sequence_response);
...
TEST(ardupilotmega, TAA_NACK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_NACK packet_in{};
    packet_in.message_type = 17443;
    packet_in.sequence_response = 17547;
    packet_in.error_type = 963497464;

    mavlink::ardupilotmega::msg::TAA_NACK packet1{};
    mavlink::ardupilotmega::msg::TAA_NACK packet2{};
    ...
    EXPECT_EQ(packet1.message_type, packet2.message_type);
    EXPECT_EQ(packet1.sequence_response, packet2.sequence_response);
    EXPECT_EQ(packet1.error_type, packet2.error_type);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_NACK)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_taa_nack_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.message_type, packet2.message_type);
    EXPECT_EQ(packet_in.sequence_response, packet2.sequence_response);
    EXPECT_EQ(packet_in.error_type, packet2.error_type);
...
TEST(ardupilotmega, TAA_DRONE_TELEMETRY)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_DRONE_TELEMETRY packet_in{};
    packet_in.sequence = 17859;
    packet_in.version = 175;
    packet_in.seconds = 93372036854775807ULL;
    packet_in.nanoseconds = 963497880;

    mavlink::ardupilotmega::msg::TAA_DRONE_TELEMETRY packet1{};
    mavlink::ardupilotmega::msg::TAA_DRONE_TELEMETRY packet2{};
    ...
    EXPECT_EQ(packet1.nanoseconds, packet2.nanoseconds);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_DRONE_TELEMETRY)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_drone_telemetry_t packet_c {
    ...
    mavlink_msg_taa_drone_telemetry_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.nanoseconds, packet2.nanoseconds);
...
TEST(ardupilotmega, TAA_GET_PARAMETERS_FROM_VEST)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_GET_PARAMETERS_FROM_VEST packet_in{};
    packet_in.parameter_list_version = 17235;
    packet_in.parameter_index = 17339;

    mavlink::ardupilotmega::msg::TAA_GET_PARAMETERS_FROM_VEST packet1{};
    mavlink::ardupilotmega::msg::TAA_GET_PARAMETERS_FROM_VEST packet2{};
    ...
    EXPECT_EQ(packet1.parameter_list_version, packet2.parameter_list_version);
    EXPECT_EQ(packet1.parameter_index, packet2.parameter_index);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_GET_PARAMETERS_FROM_VEST)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_get_parameters_from_vest_t packet_c {
         17235, 17339
    };
    ...
    mavlink_msg_taa_get_parameters_from_vest_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.parameter_list_version, packet2.parameter_list_version);
    EXPECT_EQ(packet_in.parameter_index, packet2.parameter_index);
...
TEST(ardupilotmega, TAA_SET_PARAMETERS_ON_VEST)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_SET_PARAMETERS_ON_VEST packet_in{};
    packet_in.parameter_list_version = 17443;
    packet_in.parameter_index = 17547;
    packet_in.parameter_value = 963497464;
    packet_in.interpretation_type = 29;

    mavlink::ardupilotmega::msg::TAA_SET_PARAMETERS_ON_VEST packet1{};
    mavlink::ardupilotmega::msg::TAA_SET_PARAMETERS_ON_VEST packet2{};
    ...
    EXPECT_EQ(packet1.parameter_list_version, packet2.parameter_list_version);
    EXPECT_EQ(packet1.parameter_index, packet2.parameter_index);
    EXPECT_EQ(packet1.parameter_value, packet2.parameter_value);
    EXPECT_EQ(packet1.interpretation_type, packet2.interpretation_type);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_SET_PARAMETERS_ON_VEST)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_set_parameters_on_vest_t packet_c {
    ...
    mavlink_msg_taa_set_parameters_on_vest_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.parameter_list_version, packet2.parameter_list_version);
    EXPECT_EQ(packet_in.parameter_index, packet2.parameter_index);
    EXPECT_EQ(packet_in.parameter_value, packet2.parameter_value);
    EXPECT_EQ(packet_in.interpretation_type, packet2.interpretation_type);
...
TEST(ardupilotmega, TAA_PLAY_SOUND_ON_VEST)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_PLAY_SOUND_ON_VEST packet_in{};
    packet_in.sound_index = 17443;
    packet_in.sequence = 963497464;
    packet_in.volume_level = 151;

    mavlink::ardupilotmega::msg::TAA_PLAY_SOUND_ON_VEST packet1{};
    mavlink::ardupilotmega::msg::TAA_PLAY_SOUND_ON_VEST packet2{};
    ...
    EXPECT_EQ(packet1.sound_index, packet2.sound_index);
    EXPECT_EQ(packet1.sequence, packet2.sequence);
    EXPECT_EQ(packet1.volume_level, packet2.volume_level);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_PLAY_SOUND_ON_VEST)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_play_sound_on_vest_t packet_c {
         963497464, 17443, 151
    };
    ...
    mavlink_msg_taa_play_sound_on_vest_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.sound_index, packet2.sound_index);
    EXPECT_EQ(packet_in.sequence, packet2.sequence);
    EXPECT_EQ(packet_in.volume_level, packet2.volume_level);
...
TEST(ardupilotmega, TAA_CANINE_TELEMETRY)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_CANINE_TELEMETRY packet_in{};
    packet_in.sequence = 19523;
    packet_in.version = 15;
    packet_in.seconds = 93372036854775807ULL;
    packet_in.nanoseconds = 963498712;
    packet_in.gps_lat = 179.0;
    packet_in.gps_lon = 235.0;
    packet_in.altitude_msl = 213.0;
    packet_in.altitude_hae = 241.0;
    packet_in.heading_angle = 269.0;
    packet_in.seconds_since_last_alert = 963499544;

    mavlink::ardupilotmega::msg::TAA_CANINE_TELEMETRY packet1{};
    mavlink::ardupilotmega::msg::TAA_CANINE_TELEMETRY packet2{};
    ...
    EXPECT_EQ(packet1.seconds, packet2.seconds);
    EXPECT_EQ(packet1.nanoseconds, packet2.nanoseconds);
    EXPECT_EQ(packet1.gps_lat, packet2.gps_lat);
    EXPECT_EQ(packet1.gps_lon, packet2.gps_lon);
    EXPECT_EQ(packet1.altitude_msl, packet2.altitude_msl);
    EXPECT_EQ(packet1.altitude_hae, packet2.altitude_hae);
    EXPECT_EQ(packet1.heading_angle, packet2.heading_angle);
    EXPECT_EQ(packet1.seconds_since_last_alert, packet2.seconds_since_last_alert);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_CANINE_TELEMETRY)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_canine_telemetry_t packet_c {
    ...
    mavlink_msg_taa_canine_telemetry_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.seconds, packet2.seconds);
    EXPECT_EQ(packet_in.nanoseconds, packet2.nanoseconds);
    EXPECT_EQ(packet_in.gps_lat, packet2.gps_lat);
    EXPECT_EQ(packet_in.gps_lon, packet2.gps_lon);
    EXPECT_EQ(packet_in.altitude_msl, packet2.altitude_msl);
    EXPECT_EQ(packet_in.altitude_hae, packet2.altitude_hae);
    EXPECT_EQ(packet_in.heading_angle, packet2.heading_angle);
    EXPECT_EQ(packet_in.seconds_since_last_alert, packet2.seconds_since_last_alert);
...
TEST(ardupilotmega, TAA_GET_PARAMETER_REPLY)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_GET_PARAMETER_REPLY packet_in{};
    packet_in.parameter_list_version = 17443;
    packet_in.parameter_index = 17547;
    packet_in.parameter_value = 963497464;

    mavlink::ardupilotmega::msg::TAA_GET_PARAMETER_REPLY packet1{};
    mavlink::ardupilotmega::msg::TAA_GET_PARAMETER_REPLY packet2{};
...
#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_GET_PARAMETER_REPLY)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_get_parameter_reply_t packet_c {
         963497464, 17443, 17547
    };
    ...
    mavlink_msg_taa_get_parameter_reply_encode(1, 1, &msg, &packet_c);
...
TEST(ardupilotmega, TAA_ALERT_DETECTED)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::TAA_ALERT_DETECTED packet_in{};
    packet_in.sequence = 17859;
    packet_in.alert_count = 17963;
    packet_in.seconds = 93372036854775807ULL;
    packet_in.nanoseconds = 963497880;
    packet_in.volume = 53;
    packet_in.confidence = 120;

    mavlink::ardupilotmega::msg::TAA_ALERT_DETECTED packet1{};
    mavlink::ardupilotmega::msg::TAA_ALERT_DETECTED packet2{};
    ...
    EXPECT_EQ(packet1.sequence, packet2.sequence);
    EXPECT_EQ(packet1.alert_count, packet2.alert_count);
    EXPECT_EQ(packet1.seconds, packet2.seconds);
    EXPECT_EQ(packet1.nanoseconds, packet2.nanoseconds);
    EXPECT_EQ(packet1.volume, packet2.volume);
    EXPECT_EQ(packet1.confidence, packet2.confidence);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, TAA_ALERT_DETECTED)
{
    mavlink_message_t msg;
    ...
    mavlink_taa_alert_detected_t packet_c {
    ...
    mavlink_msg_taa_alert_detected_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.sequence, packet2.sequence);
    EXPECT_EQ(packet_in.alert_count, packet2.alert_count);
    EXPECT_EQ(packet_in.seconds, packet2.seconds);
    EXPECT_EQ(packet_in.nanoseconds, packet2.nanoseconds);
    EXPECT_EQ(packet_in.volume, packet2.volume);
    EXPECT_EQ(packet_in.confidence, packet2.confidence);
